...
/*
[函数名称]HuffmanTree
[函数功能]给定的权值数组创建Huffman树。
[函数参数]HTree &pHT:Huffman 树
[函数参数]int *aWeight: 权值数组
...
/*
[函数名称]Select
[函数功能]选择Huffman树前nSize个元素中parent为0且weight最小的节点，返回其序号。
[函数参数]HTree pHT:Huffman 树
[函数参数]int nSize: 前 nSize 个数
[返回值] 最小权值的坐标
*/
...
/*
[函数名称]HuffmanCoding
[函数功能]遍历Huffman树，生成Huffman编码
[函数参数]HCode&pHC:Huffman 编码
[函数参数]HTree&pHT: Huffman数
[返回值] int:ERROR 异常；OK 正常
*/
